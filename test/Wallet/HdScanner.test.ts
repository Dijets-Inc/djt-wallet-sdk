...
import { getAccountPathDijets } from '@/Wallet/helpers/derivationHelper';
...
import { activeNetwork, dijets, explorer_api } from '@/Network/network';
...
let accountKey = masterHdKey.derivePath(getAccountPathDijets(0));
