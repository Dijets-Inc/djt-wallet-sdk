...
const addrP = 'P-djtx19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
const addrX = 'X-djtx19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
...
describe('validate address', () => {
    ...
    it('should fail for random chain id', () => {
        let address = 'F-djtx19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
        //@ts-ignore
...
describe('get HRP', () => {
    it('Return djtx HRP', () => {
        ...
        expect(res).toBe('djtx');
        expect(res2).toBe('djtx');
    });
