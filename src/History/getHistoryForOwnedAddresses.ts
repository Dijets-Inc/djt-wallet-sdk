import { filterDuplicateOrtelius, getAddressHistory, getAddressHistoryEVM, OrteliusDijetsTx } from '@/Explorer';
 ...
 * @param limit
 */
export async function getHistoryC(addrC: string, addrsX: string[], limit = 0): Promise<OrteliusDijetsTx[]> {
