...
import { PayloadBase } from 'dijets/dist/utils';
import { OutputOwners } from 'dijets/dist/common';
import { PlatformVMConstants, UTXOSet as PlatformUTXOSet } from 'dijets/dist/apis/platformvm';

import { EVMConstants } from 'dijets/dist/apis/evm';
...
export async function buildMintNftTx(
    ...
    let addrBuf = bintools.parseAddress(ownerAddress, 'V');
    let owners = [];
