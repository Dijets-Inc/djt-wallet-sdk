import { BN, Buffer as BufferDijets } from 'dijets';
import { dijets, web3 } from '@/Network/network';
import { ethers } from 'ethers';
import { KeyPair as EVMKeyPair } from 'dijets/dist/apis/evm/keychain';
...
export class EvmWalletReadonly {
    ...
    getAddressBech32(): string {
        ...
        let addr = EVMKeyPair.addressFromPublicKey(BufferDijets.from(compressedKey.substring(2), 'hex'));
        return bintools.addressToString(dijets.getHRP(), 'U', addr);
    }
