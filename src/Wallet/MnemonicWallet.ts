...
import { Tx as AVMTx, UnsignedTx as AVMUnsignedTx } from 'dijets/dist/apis/avm';
import { Tx as PlatformTx, UnsignedTx as PlatformUnsignedTx } from 'dijets/dist/apis/platformvm';
import { KeyPair as AVMKeyPair, KeyChain as AVMKeyChain } from 'dijets/dist/apis/avm/keychain';
import { KeyChain as PlatformKeyChain } from 'dijets/dist/apis/platformvm';
import { UnsignedTx as EVMUnsignedTx, Tx as EVMTx, KeyPair as EVMKeyPair } from 'dijets/dist/apis/evm';
...
export class MnemonicWallet extends HDWalletAbstract implements UnsafeWallet {
    ...
    constructor(mnemonic: string, account = 0) {
        ...
        let accountKey = masterHdKey.derivePath(getAccountPathDijets(account));
