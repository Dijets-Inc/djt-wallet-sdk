...
import { UTXOSet as AVMUTXOSet } from 'dijets/dist/apis/avm/utxos';
import { dijets } from '@/Network/network';
import { UTXOSet as PlatformUTXOSet } from 'dijets/dist/apis/platformvm';
...
export abstract class HDWalletAbstract extends WalletProvider {
    ...
    public async getExternalAddressesX(): Promise<string[]> {
        return await this.externalScan.getAllAddresses('V');
    }
    ...
    public getExternalAddressesXSync(): string[] {
        return this.externalScan.getAllAddressesSync('V');
    }
    ...
    public async getInternalAddressesX(): Promise<string[]> {
        return await this.internalScan.getAllAddresses('V');
    }
    ...
    public getInternalAddressesXSync(): string[] {
        return this.internalScan.getAllAddressesSync('V');
    }
    ...
    public async getExternalAddressesP(): Promise<string[]> {
        return this.externalScan.getAllAddresses('M');
    }

    public getExternalAddressesPSync(): string[] {
        return this.externalScan.getAllAddressesSync('M');
    }
    ...
    public async updateUtxosX(): Promise<AVMUTXOSet> {
        ...
        let utxoAddrsStr = utxoAddrs.map((addr) => {
            return bintools.addressToString(dijets.getHRP(), 'V', addr);
        });
    ...
    public async updateUtxosP(): Promise<PlatformUTXOSet> {
        ...
        let utxoAddrsStr = utxoAddrs.map((addr) => {
            return bintools.addressToString(dijets.getHRP(), 'M', addr);
        });
